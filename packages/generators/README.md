...
@haxcms/generators/0.0.6 darwin-x64 node-v12.13.0
...
_See code: [src/commands/swarm.js](https://github.com/elmsln/haxcms-tools/blob/v0.0.6/src/commands/swarm.js)_
...
_See code: [src/commands/upgrade-browser.js](https://github.com/elmsln/haxcms-tools/blob/v0.0.6/src/commands/upgrade-browser.js)_
<!-- commandsstop -->
